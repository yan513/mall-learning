...
import com.yl.mall.common.component.RestfulAccessDeniedHandler;
import com.yl.mall.dto.AdminUserDetails;
...
//                .permitAll()
    ...
    public UserDetailsService userDetailsService() {
        ...
        return username -> {
            ...
            if (admin != null) {
                List<UmsPermission> permissionList = permissionService.getPermissionList(admin.getId());
